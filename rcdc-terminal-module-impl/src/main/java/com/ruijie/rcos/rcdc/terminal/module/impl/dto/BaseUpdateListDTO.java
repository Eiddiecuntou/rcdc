 ...
 * @author nt
 */
public class BaseUpdateListDTO<T> extends EqualsHashcodeSupport implements Serializable {
    ...
    public BaseUpdateListDTO() {
    }

    public BaseUpdateListDTO(String version, Integer componentSize) {
