 ...
 */
@Service
@Quartz(cron = "0/10 * * * * ?", scheduleTypeCode = "terminal_terminal_detect", scheduleName = BusinessKey.RCDC_TERMINAL_QUARTZ_DETECT_TIME_OUT)
public class TerminalDetectTimeoutQuartzTask implements QuartzTask {

    private static final Logger LOGGER = LoggerFactory.getLogger(TerminalDetectTimeoutQuartzTask.class);
