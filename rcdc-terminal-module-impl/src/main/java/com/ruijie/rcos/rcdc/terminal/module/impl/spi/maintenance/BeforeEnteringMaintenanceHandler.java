...
public class BeforeEnteringMaintenanceHandler {
    ...
    public void handle() throws BusinessException {
        TerminalSystemUpgradePackageEntity packageEntity = systemUpgradePackageDAO.findFirstByPackageType(CbbTerminalTypeEnums.VDI_LINUX);
        if (packageEntity == null || packageEntity.getIsDelete()) {
