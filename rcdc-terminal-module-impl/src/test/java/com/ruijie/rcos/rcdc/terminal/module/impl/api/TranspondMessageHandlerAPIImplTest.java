...
public class TranspondMessageHandlerAPIImplTest {
    @Tested
    private TranspondMessageHandlerAPIImpl transpondMessageHandlerAPI;
    ...
    public void testSyncRequestSuccess() throws IOException, InterruptedException, BusinessException {
        ...
        request.setTerminalId("123");
        try {
            ShineMessageResponse messageResponse = transpondMessageHandlerAPI.syncRequest(request);
