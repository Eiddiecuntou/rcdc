...
public interface CbbTerminalConnectHandlerSPI {
     ...
     */
    boolean isAllowConnect(CbbShineTerminalBasicInfo terminalBasicInfo);
 ...
 */
     ...
     *
     * @param terminalBasicInfo 终端信息
     * @return CbbTerminalBizConfigDTO 终端业务设置
     */
    CbbTerminalBizConfigDTO notifyTerminalSupport(CbbShineTerminalBasicInfo terminalBasicInfo);
}
