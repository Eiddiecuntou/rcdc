...
public class TerminalOperateControllerTest {
     ...
     */
    @Test
    public void testRestartTerminal(@Mocked ProgrammaticOptLogRecorder optLogRecorder,
            @Mocked BatchTaskBuilder builder, 
            @Mocked TerminalIdMappingUtils utils) throws BusinessException {
        TerminalIdArrWebRequest request = new TerminalIdArrWebRequest();
        UUID[] uuidArr = new UUID[1];
     ...
     */
    @Test
    public void testChangePasswordArgumentIsNull(@Mocked ProgrammaticOptLogRecorder optLogRecorder) 
            throws Exception {
    ...
    public void testDownloadLog() throws BusinessException, IOException {
        TerminalIdDownLoadWebRequest request = new TerminalIdDownLoadWebRequest();
        ...
        new Expectations() {
            {
                terminalOperatorAPI.getTerminalLogFileInfo((CbbTerminalIdRequest) any);
                result = response;
            }
        };
