...
public class RetryUpgradeTerminalBatchTaskHandler extends AbstractBatchTaskHandler {
    ...
    public RetryUpgradeTerminalBatchTaskHandler(CbbTerminalSystemUpgradeAPI cbbTerminalUpgradeAPI, Map<UUID, String> idMap,
    ...
    private BatchTaskItemResult retryUpgradeTerminalAddOptLog(String terminalId, UUID upgradeTaskId) throws BusinessException {
        ...
        try {
            ...
            return DefaultBatchTaskItemResult.builder().batchTaskItemStatus(BatchTaskItemStatus.SUCCESS)
                    .msgKey(BusinessKey.RCDC_RETRY_UPGRADE_TERMINAL_RESULT_SUCCESS).msgArgs(new String[] {terminalId}).build();
            ...
            return DefaultBatchTaskItemResult.builder().batchTaskItemStatus(BatchTaskItemStatus.FAILURE)
                    .msgKey(BusinessKey.RCDC_RETRY_UPGRADE_TERMINAL_RESULT_FAIL).msgArgs(new String[] {terminalId, e.getI18nMessage()}).build();
        }
    }
